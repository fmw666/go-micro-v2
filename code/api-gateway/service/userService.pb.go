...
type UserLoginRequest struct {
	...
	Username string `protobuf:"bytes,1,opt,name=username,proto3" json:"username" form:"username" uri:"username"`
...
type UserRegisterRequest struct {
	...
	PasswordConfirm string `protobuf:"bytes,3,opt,name=password_confirm,json=passwordConfirm,proto3" json:"password_confirm" form:"password_confirm" uri:"password_confirm"`
}
...
type User struct {
	...
	Id uint32 `protobuf:"varint,1,opt,name=id,proto3" json:"id" form:"id" uri:"id"`
	// @inject_tag: json:"username" form:"username" uri:"username"
	Username string `protobuf:"bytes,2,opt,name=username,proto3" json:"username" form:"username" uri:"username"`
	// @inject_tag: json:"created_at" form:"created_at" uri:"created_at"
	CreatedAt string `protobuf:"bytes,3,opt,name=created_at,json=createdAt,proto3" json:"created_at" form:"created_at" uri:"created_at"`
	// @inject_tag: json:"updated_at" form:"updated_at" uri:"updated_at"
	UpdatedAt string `protobuf:"bytes,4,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at" form:"updated_at" uri:"updated_at"`
}
...
type UserResponse struct {
	...
	User *User `protobuf:"bytes,1,opt,name=user,proto3" json:"user" form:"user" uri:"user"`
	// @inject_tag: json:"token" form:"token" uri:"token"
	Token string `protobuf:"bytes,2,opt,name=token,proto3" json:"token" form:"token" uri:"token"`
}
...
type UserDetailResponse struct {
	...
	Data *UserResponse `protobuf:"bytes,1,opt,name=data,proto3" json:"data" form:"data" uri:"data"`
	// @inject_tag: json:"code" form:"code" uri:"code"
	Code uint32 `protobuf:"varint,2,opt,name=code,proto3" json:"code" form:"code" uri:"code"`
	// @inject_tag: json:"message,omitempty" form:"message" uri:"message"
	Message string `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty" form:"message" uri:"message"`
}
...
func (x *UserDetailResponse) GetData() *UserResponse {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_userService_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x4a, 0x0a, 0x10,
	...
	0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x78, 0x0a, 0x13, 0x55, 0x73, 0x65, 0x72,
	...
	0x72, 0x6d, 0x22, 0x70, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73,
	0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73,
	0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x65, 0x64, 0x41, 0x74, 0x22, 0x47, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x6d, 0x0a,
	...
	0x0b, 0x32, 0x15, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x55, 0x73, 0x65, 0x72,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x12,
	...
	0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x43, 0x0a, 0x09,
	0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x19, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	0x65, 0x12, 0x49, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	0x72, 0x12, 0x1c, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x55, 0x73, 0x65, 0x72,
	0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1b, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0c, 0x5a, 0x0a,
...
var file_userService_proto_goTypes = []interface{}{
	...
	(*UserDetailResponse)(nil),  // 4: service.UserDetailResponse
}
var file_userService_proto_depIdxs = []int32{
	2, // 0: service.UserResponse.user:type_name -> service.User
	3, // 1: service.UserDetailResponse.data:type_name -> service.UserResponse
	0, // 2: service.UserService.UserLogin:input_type -> service.UserLoginRequest
	1, // 3: service.UserService.UserRegister:input_type -> service.UserRegisterRequest
	4, // 4: service.UserService.UserLogin:output_type -> service.UserDetailResponse
	4, // 5: service.UserService.UserRegister:output_type -> service.UserDetailResponse
