...
func (x *OrderModel) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func (x *OrderModel) GetDeletedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.DeletedAt
	}
	return nil
...
var file_orderModel_proto_rawDesc = []byte{
	...
	0x0a, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x0e, 0x0a, 0x02, 0x49,
	...
	0x16, 0x0a, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x12, 0x38, 0x0a, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x3b, 0x73, 0x65, 0x72, 0x76,
...
var file_orderModel_proto_goTypes = []any{
	(*OrderModel)(nil),            // 0: service.OrderModel
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_orderModel_proto_depIdxs = []int32{
	1, // 0: service.OrderModel.CreatedAt:type_name -> google.protobuf.Timestamp
	1, // 1: service.OrderModel.UpdatedAt:type_name -> google.protobuf.Timestamp
	1, // 2: service.OrderModel.DeletedAt:type_name -> google.protobuf.Timestamp
...
func file_orderModel_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_orderModel_proto_msgTypes[0].Exporter = func(v any, i int) any {
