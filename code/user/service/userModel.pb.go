...
func (x *UserModel) GetDeletedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.DeletedAt
	}
	return nil
...
var file_userModel_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x02, 0x0a, 0x09,
	...
	0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x3b, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x00, 0x62,
...
var file_userModel_proto_depIdxs = []int32{
	1, // 0: service.UserModel.CreatedAt:type_name -> google.protobuf.Timestamp
	1, // 1: service.UserModel.UpdatedAt:type_name -> google.protobuf.Timestamp
	1, // 2: service.UserModel.DeletedAt:type_name -> google.protobuf.Timestamp
